...
export function Om() {
    ...
    return (
      ...
      <p>Hearthstone is a free-to-play online digital collectible card game developed and published by Blizzard Entertainment. Originally subtitled Heroes of Warcraft, Hearthstone builds upon the existing lore of the Warcraft series by using the same elements, characters, and relics. It was first released for Windows and macOS in March 2014, with ports for iOS and Android released later that year. The game features cross-platform play, allowing players on any supported device to compete with one another, restricted only by geographical region account limits.
        ...
        The game has been favorably reviewed by critics and considered a success for Blizzard, earning nearly US$40 million per month as of August 2017.[5] As of November 2018, Blizzard has reported more than 100 million Hearthstone players.[6] The game has become popular as an esport, with cash prize tournaments hosted by Blizzard and other organizers. </p>
      <img src="/src/assets/images/aboutHearthstone.jpg" alt="aboutBackground" />
      </div>
